Aqui está um detalhamento mais abrangente do **Plano de Ensino** da disciplina **Programação Orientada a Objetos (POO)**, oferecida pela **Universidade Franciscana (UFN)** no semestre **2025/1**.
